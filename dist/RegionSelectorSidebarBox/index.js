...
var MemoRowHeader = /*#__PURE__*/memo(RowHeader);
...
var MemoRow = /*#__PURE__*/memo(Row, function (prevProps, nextProps) {
...
export var RegionSelectorSidebarBox = function RegionSelectorSidebarBox(_ref4) {
  ...
  return /*#__PURE__*/React.createElement(SidebarBoxContainer, {
    ...
    key: 'row-header'
  }), /*#__PURE__*/React.createElement(HeaderSep, {
    key: 'header-sep'
...
export default /*#__PURE__*/memo(RegionSelectorSidebarBox, function (prevProps, nextProps) {
