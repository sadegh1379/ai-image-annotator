...
export const RightSidebar = ({
  ...
  const [expanded, toggleExpanded] = useReducer(state => !state, initiallyExpanded === undefined ? getInitialExpandedState() : initiallyExpanded);
  useEffect(() => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classnames(classes.container, expanded ? 'expanded' : '', toggleable ? 'borderRight' : ''),
    style: containerStyle
  }, /*#__PURE__*/React.createElement("div", {
    className: classnames(classes.slider, expanded ? 'expanded' : '')
  }, /*#__PURE__*/React.createElement("div", {
    className: classnames(classes.innerSliderContent)
  }, children)), toggleable && /*#__PURE__*/React.createElement(ButtonBase, {
    onClick: toggleExpanded,
    className: classnames(classes.expander, expanded ? 'expanded' : '')
