...
const getIcon = (name, customIconMapping) => {
  const Icon = customIconMapping[name.toLowerCase()] || defaultNameIconMapping[name.toLowerCase()] || defaultNameIconMapping.help;
...
export const HeaderButton = ({
  ...
  return /*#__PURE__*/React.createElement(Button, {
    onClick: onClick,
    disabled: disabled,
    className: classnames(classes.styledButton)
  }, /*#__PURE__*/React.createElement("div", {
    className: classnames(classes.buttonInnerContent)
  }, /*#__PURE__*/React.createElement("div", {
    className: classnames(classes.iconContainer)
  }, icon || getIcon(name, customIconMapping)), !hideText && /*#__PURE__*/React.createElement("div", {
